...
function Day (first, second, third, fourth, five, six) {
    var fields = ['clock', 'bookmark', 'tag', 'home', 'person'],
        lessons = [ first, second, third, fourth, five, six ];

    this.table=function(curr) {
        var tbl = $('<table/>', { class: 'dayTbl' }),
            th = $('<tr/>');

        $.each(fields, function(i,f) {
            th.append(
                $('<td/>', { class: 'ui-state-default ui-corner-top' }).append(
                    $('<span/>', { class: 'ui-icon ui-icon-' + f })
                )
            )
        });
...
function Para (time,predmet, type, kab, prepod) {
    ...
    this.tab = function (curr){
        if (this.predmet!=="")
        {
            if(this.check_date(curr)=="5")
            {
                return "<tr ><td class='time ui-corner-all'><p>"+this.time+"<p></td><td class='predmet ui-corner-all'><p>Проектирование и эксплуатация эк. корп. ИС</p></td><td class='typ ui-corner-all'><p>"+this.type+"</p></td><td class='kab ui-corner-all'><p>"+this.kab+"</p></td><td class='prep ui-corner-all'><p>Аминов Х.И.</p></td></tr>"
            }
            if(this.check_date(curr)=="6")
            {
                return "<tr ><td class='time ui-corner-all'><p>"+this.time+"<p></td><td class='predmet ui-corner-all'><p>"+this.predmet+"</p></td><td class='typ ui-corner-all'><p>Практика</p></td><td class='kab ui-corner-all'><p>"+this.kab+"</p></td><td class='prep ui-corner-all'><p>"+this.prepod+"</p></td></tr>"
            }
            if(this.check_date(curr)=="2")
            {
                return "<tr ><td class='time ui-corner-all'><p>"+this.time+"<p></td><td class='predmet ui-corner-all grb'><p>"+this.predmet+"</p></td><td class='typ ui-corner-all grb'><p>"+this.type+" ('Б')</p></td><td class='kab ui-corner-all'><p>"+this.kab+"</p></td><td class='prep ui-corner-all'><p>"+this.prepod+"</p></td></tr>"
            }

            if(this.check_date(curr)=="1" & this.type!=='Лаб')
            {
                return "<tr><td class='time ui-corner-all'><p>"+this.time+"<p></td><td class='predmet ui-corner-all'><p>"+this.predmet+"</p></td><td class='typ ui-corner-all'><p>"+this.type+"</p></td><td class='kab ui-corner-all'><p>"+this.kab+"</p></td><td class='prep ui-corner-all'><p>"+this.prepod+"</p></td></tr>"
            }
            if(this.check_date(curr)=="1" & this.type=='Лаб')
            {
                return "<tr ><td class='time ui-corner-all'><p>"+this.time+"<p></td><td class='predmet ui-corner-all grb'><p>"+this.predmet+"</p></td><td class='typ ui-corner-all gra'><p>"+this.type+" ('А')</p></td><td class='kab ui-corner-all'><p>"+this.kab+"</p></td><td class='prep ui-corner-all'><p>"+this.prepod+"</p></td></tr>"
            }
            if(this.check_date(curr)=="0")
            {
                return "<tr><td class='time ui-datepicker-unselectable ui-state-disabled ui-corner-all'>"+this.time+"</td><td class='predmet ui-corner-all ui-datepicker-unselectable ui-state-disabled'><p>"+this.predmet+"</p></td><td class='typ ui-corner-all ui-datepicker-unselectable ui-state-disabled'><p>"+this.type+"</p></td><td class='kab ui-corner-all ui-datepicker-unselectable ui-state-disabled'><p>"+this.kab+"</p></td><td class='prep ui-corner-all ui-datepicker-unselectable ui-state-disabled'><p>"+this.prepod+"</p></td></tr>"
            }
        }
        else
        {
            return "<tr><td class='time ui-datepicker-unselectable ui-state-disabled  ui-corner-all'>"+this.time+"</td><td class='predmet ui-corner-all ui-datepicker-unselectable ui-state-disabled'></td><td class='typ ui-corner-all ui-datepicker-unselectable ui-state-disabled'></td><td class='kab ui-corner-all ui-datepicker-unselectable ui-state-disabled'></td><td class='prep ui-corner-all ui-datepicker-unselectable ui-state-disabled'></td></tr>"
        }
    };
    
    this.check_date = function(curr) {
        var a, b, c,
...
$(function() {
    ...
    $("#week_tog").buttonset().show();
    $("#gr_tog").buttonset().show();
    $("#tip").buttonset().show();
    ...
    $("#gr_tog").click('input', function(event)	{
        var elem = $(event.target);
        $("#adv").hide();
        $.each( groups, function(i, gr) {
            if ( elem.hasClass( gr ) ) {
                check_gr( gr, dateText );
                //load_mes( gr );
            }
        });
